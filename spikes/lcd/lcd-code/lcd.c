...
#define CS_PIN 0b00100000   // PB5
#define WR_PIN 0b00010000   // PB4
#define DATA_PIN 0b00001000 // PB3

#define T_CLK 4 // the clock time in micro seconds
...
void main()
{
    ...
    //         unsigned char data = (0b0000000000001110 >> (j * 4)) & 0b1111;
    //         // 0b0000111000000111
